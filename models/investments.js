...
exports.getinvestmentList = function(id) {
    return query(
            "SELECT * FROM  user_holding where user_id=$1 order by purchase_date desc; ", [id]
        ).then(function(list) {
            return list;
        })
        .catch(function(err) {
...
exports.createInvestment = function(userid, ticker, name, quantity, pruchaseprice, currentprice, purchasedate, CONSTANT_VAL) {
    return query(
            ...
            "VALUES($1,$2,$3,$4,$5,$6,$7,$8) RETURNING *", [userid, ticker, name, quantity, pruchaseprice, currentprice, purchasedate, CONSTANT_VAL]
...
exports.updateInvestment = function(id, quantity, profit) {
    ...
    return query(
            "UPDATE user_holding SET quantity=$2,current_profit=$3 WHERE id=$1 RETURNING *", [id, quantity, profit]
...
exports.deleteInvestment = function(id) {
    return query(
            "DELETE FROM user_holding WHERE id=$1 RETURNING *", [id]
        ).then(function(holding) {
            return holding[0];
        })
        .catch(function(err) {
...
exports.setUpdatePrice = function(id, price, profit) {
    return query(
            "UPDATE user_holding SET current_price=$2,current_profit=$3 WHERE id=$1 RETURNING *", [id, price, profit]
        ).then(function(holding) {
            return holding[0];
        })
        .catch(function(err) {
